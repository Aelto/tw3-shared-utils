...
class CR4HudModuleBuffs extends CR4HudModuleBase
{
	...
	event OnTick( timeDelta : float )
	{
		...
		// sharedutils - custom cooldowns - BEGIN & END
		if ( _currentEffects.Size() == 0 && _previousEffects.Size() == 0 && thePlayer.custom_cooldowns.Size() == 0 )
			return true;
	...
	function UpdateBuffs()
	{
		...
		// sharedutils - custom cooldowns - BEGIN
		SU_injectCustomCooldowns(l_flashArray, m_flashValueStorage, this);
		// sharedutils - custom cooldowns - END
